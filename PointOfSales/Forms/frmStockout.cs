...
namespace PointOfSales.Forms
{
    public partial class frmStockout : Form
    {
        ...
        public frmStockout(string txt)
        {
            InitializeComponent();
            UserIdStatusStrip.Text = txt;
        }
        ...
        private void txtDiscount_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                double vat;
                double grandtotal;
                discount = double.Parse(txtDiscount.Text) / 100;

                totdiscount = double.Parse(txtSubTotal.Text) * discount;
                totalamount = double.Parse(txtSubTotal.Text) - totdiscount;

                vat = double.Parse(txtSubTotal.Text) * 0.12;
        ...
        private void frmStockout_FormClosing(object sender, FormClosingEventArgs e)
        {
